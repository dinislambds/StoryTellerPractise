<?php
/**
 * storyteller functions and definitions.
 *
...
function storyteller_setup() {
	 ...
	 * If you're building a theme based on storyteller, use a find and replace
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'storyteller' ),
	) );
...
function storyteller_scripts() {
	...
	wp_enqueue_script( 'storyteller-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'storyteller-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
require get_template_directory().'/inc/redux-framework/redux-framework.php';
require get_template_directory().'/inc/custom-redux-framework.php';
require get_template_directory().'/inc/custom-cmb2-metabox.php';
